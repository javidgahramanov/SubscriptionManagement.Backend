...
namespace SubscriptionManagement.DataAccess.Migrations
{
    ...
    [Migration("20200906165427_Add_Reseller_Entity")]
    partial class Add_Reseller_Entity
    {
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 16, 54, 26, 793, DateTimeKind.Utc).AddTicks(4757),
                            ModifiedAt = new DateTime(2020, 9, 6, 16, 54, 26, 793, DateTimeKind.Utc).AddTicks(4780),
                            Price = 25m,
                            ResellerId = new Guid("9ef291a7-5f8d-4bc7-bd00-34bb438e43a6")
                        },
                        new
                        {
                            ...
                            CatalogId = new Guid("ac06b5ad-af65-435c-bb49-4adb5668fd67"),
                            CreatedAt = new DateTime(2020, 9, 6, 16, 54, 26, 793, DateTimeKind.Utc).AddTicks(9943),
                            ModifiedAt = new DateTime(2020, 9, 6, 16, 54, 26, 793, DateTimeKind.Utc).AddTicks(9961),
                            Price = 30m,
                            ResellerId = new Guid("9ef291a7-5f8d-4bc7-bd00-34bb438e43a6")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 16, 54, 26, 794, DateTimeKind.Utc).AddTicks(133),
                            ModifiedAt = new DateTime(2020, 9, 6, 16, 54, 26, 794, DateTimeKind.Utc).AddTicks(140),
                            Price = 40m,
                            ResellerId = new Guid("17948b03-bdcc-436b-8006-78022fe3008a")
                        });
                });

            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.BookUserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BookUserSubscriptions");

                    b.HasData(
                        new
                        {
                            Id = new Guid("d0f3167b-dfbb-422b-8bb5-e5c7c8816955"),
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Reseller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 16, 54, 26, 795, DateTimeKind.Utc).AddTicks(9638),
                            ModifiedAt = new DateTime(2020, 9, 6, 16, 54, 26, 795, DateTimeKind.Utc).AddTicks(9668),
                            ResellerName = "System"
                        },
                        new
                        {
                            Id = new Guid("17948b03-bdcc-436b-8006-78022fe3008a"),
                            CreatedAt = new DateTime(2020, 9, 6, 16, 54, 26, 796, DateTimeKind.Utc).AddTicks(1064),
                            ModifiedAt = new DateTime(2020, 9, 6, 16, 54, 26, 796, DateTimeKind.Utc).AddTicks(1075),
                            ResellerName = "Amazon"
                        });
                });
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Book", b =>
                {
                    ...
                    b.HasOne("SubscriptionManagement.Domains.Entities.Reseller", "Reseller")
                        .WithMany("Books")
