...
namespace SubscriptionManagement.DataAccess.Migrations
{
    ...
    [Migration("20200905132217_AddedPrice_To_book")]
    partial class AddedPrice_To_book
    {
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(3983),
                            ModifiedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(3998),
                            Price = 25m
                        },
                        new
                        {
                            ...
                            CatalogId = new Guid("ac06b5ad-af65-435c-bb49-4adb5668fd67"),
                            CreatedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(7341),
                            ModifiedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(7354),
                            Price = 30m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(7450),
                            ModifiedAt = new DateTime(2020, 9, 5, 13, 22, 16, 55, DateTimeKind.Utc).AddTicks(7453),
                            Price = 40m
                        });
                });
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.BookUserSubscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0a99c65-9adf-4364-976e-5cfe8d0ba351"),
