...
namespace SubscriptionManagement.DataAccess.Migrations
{
    ...
    [Migration("20200906172555_Provided_Reselling_Possilibity")]
    partial class Provided_Reselling_Possilibity
    {
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 17, 25, 54, 473, DateTimeKind.Utc).AddTicks(9792),
                            ModifiedAt = new DateTime(2020, 9, 6, 17, 25, 54, 473, DateTimeKind.Utc).AddTicks(9800),
                            Price = 25m,
                        ...
                        new
                        {
                            ...
                            CatalogId = new Guid("ac06b5ad-af65-435c-bb49-4adb5668fd67"),
                            CreatedAt = new DateTime(2020, 9, 6, 17, 25, 54, 474, DateTimeKind.Utc).AddTicks(3015),
                            ModifiedAt = new DateTime(2020, 9, 6, 17, 25, 54, 474, DateTimeKind.Utc).AddTicks(3022),
                            Price = 30m,
                            ResellerId = new Guid("9ef291a7-5f8d-4bc7-bd00-34bb438e43a6")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 17, 25, 54, 474, DateTimeKind.Utc).AddTicks(3084),
                            ModifiedAt = new DateTime(2020, 9, 6, 17, 25, 54, 474, DateTimeKind.Utc).AddTicks(3086),
                            Price = 40m,
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.Reseller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 9, 6, 17, 25, 54, 475, DateTimeKind.Utc).AddTicks(5531),
                            ModifiedAt = new DateTime(2020, 9, 6, 17, 25, 54, 475, DateTimeKind.Utc).AddTicks(5542),
                            ResellerName = "System"
                        },
                        new
                        {
                            Id = new Guid("17948b03-bdcc-436b-8006-78022fe3008a"),
                            CreatedAt = new DateTime(2020, 9, 6, 17, 25, 54, 475, DateTimeKind.Utc).AddTicks(6339),
                            ModifiedAt = new DateTime(2020, 9, 6, 17, 25, 54, 475, DateTimeKind.Utc).AddTicks(6346),
                            ResellerName = "Amazon"
                        });
                });
            ...
            modelBuilder.Entity("SubscriptionManagement.Domains.Entities.UserBook", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e387e0f-744d-43ba-b4b0-ce9728239457"),
